...
(function (window, undefined) {
    ...
    ClearBlade.Messaging = function(options){
		...
		var defaultWillMessage = new Messaging.Message("default will message");
		defaultWillMessage.destinationName="whoknows";
		conf["willMessage"] = options["willMessage"] || defaultWillMessage;
		...
		conf["ports"] = options["ports"] == null ? [8080] : options["ports"].concat([8080]);
	 ...
	 */
    ClearBlade.Messaging.prototype.Subscribe = function (topic,options){
	var conf = {};
